...
- **-grid**: Insert the name of a pre-existing grid in DS9 fk5 format to be loaded on the images. The corresponding ptp analysis scatter plot is produced and saved in out_[grid name].jpg
- **-h** Print help
